...
public class TranslateIdentityMessagesToPortuguese : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"SignIn '{userName}' é inválido, pode conter apenas letras ou dígitos." }; }
    ...
    public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"SignIn '{userName}' já está sendo utilizado." }; }
